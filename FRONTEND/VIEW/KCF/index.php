...
$result=mysqli_query($connection, "SELECT award_id,award_name, award_type FROM awards_section WHERE fellowship_id=111");
?>
...
<html lang="en">
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          chart: {
            title: 'KCF Fellowship Performance',
            subtitle: 'KCF Awards Won 2020-2021',
          }
        };
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-primary bg-primary">
            ...
            <a class="navbar-brand ps-3" href="index.php">
                <!--put logo here-->
                <img src="kcf.jpeg" alt="Logo" width="50px" height="50px" style="background-color:blue;">
            </a>
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapsePages" aria-expanded="false" aria-controls="collapsePages">
                                <div class="sb-nav-link-icon text-primary"><i class="fas fa-book-open"></i></div>
                                ...
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                                    ...
                                    <div class="collapse" id="collapsePages" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            <a class="nav-link" href="insertTestimony.php"> My Testimony</a>
                                        </nav>
                                    </div>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="xtra.php">View Details</a>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="KCFalumni.php">View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="birthdays.php">View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card mb-4">
                            <div class="card-header text-light bg-dark">
                                ...
                                KCF Members Testimony Section
                            </div>
                            <div class="card-body">
                            <?php 
                            $query="SELECT testimonies.testimony_statement, testimonies.testimony_date, fellowship_testimony.fellowship_id 
                            FROM testimonies INNER JOIN fellowship_testimony on fellowship_testimony.testimony_id=testimonies.testimony_id WHERE fellowship_id=111";
