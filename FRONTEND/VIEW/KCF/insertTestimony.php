...
// testimony form controller--some changes need to be here. Should be member and not fellowship, 
            ...
            if(isset($_POST['postKCF'])){
                ...
                $sqlQuery="INSERT INTO kcf_user_testimony (user_id,testimony_statement, testimony_date) VALUES ('$user_id','$testimony_statement','$testimony_date')";
...
<form style="margin-left: 270px; margin-top: -779px; width:1100px" method="POST">
  ...
  <button type="submit" name="postKCF" class="btn btn-primary">Submit</button>
</form><br>
...
<div class="card w-75" style="margin-top: 12px; margin-left:270px">
  ...
  <div class="card-body">
    <!--fellowship_testimony, FOR update and delete-->
      ...
      <?php 
                            ...
                            $query="SELECT users.user_id, users.fname, users.lname, kcf_user_testimony.testimony_statement, kcf_user_testimony.testimony_id, kcf_user_testimony.testimony_date
                             FROM users INNER JOIN kcf_user_testimony on kcf_user_testimony.user_id=$user_id WHERE 
                             fellowship_id=111 AND users.user_id=$user_id";
  ...
  <div class="card-footer text-light bg-success">
      <p>KCF we dey jaaaayymm in Holy Ghost</p>
  </div>
</div>
</body>
</html>