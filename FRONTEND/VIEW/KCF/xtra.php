...
<head>
    ...
    <title>KCF member Curricula Page</title>
...
<div class="card w-75" style="margin-top: -600px; margin-left:270px">
  ...
  <span><i class='fas fa-skating'></i><i class='fas fa-table-tennis'></i>Extra Activities</span>
  </div>
  <div class="card-body">
      ...
      //to get extra currcula activities of just KCF--> 
                            ...
                            FROM  extra_curriculum INNER JOIN fellowship_curriculum on fellowship_curriculum.extra_id=extra_curriculum.extra_id WHERE fellowship_id=111";
