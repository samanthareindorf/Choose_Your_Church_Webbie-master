...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <img src="kcf.jpeg" alt="Logo" width="200px" height="210px" style="margin-top: -100px;">
      </a>
    </div>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="KCF_img_1.jpeg" alt="First Slide" class="center" style=" width:auto; height:600px; " >
      </div>

      <div class="item">
        <img src="KCF_img_2.jpeg" alt="Second Slide" class="center" style=" width:auto; height:600px;">
      </div>
    
      <div class="item">
        <img src="KCF_img_3.jpeg" alt="Third Slide" class="center" style=" width:auto; height:600px;">
      </div>

      <div class="item">
        <img src="KCF_img_4.jpeg" alt="Second Slide" class="center" style=" width:auto; height:600px;">
      </div>
    
      <div class="item">
        <img src="KCF_img_5.jpeg" alt="Third Slide" class="center" style=" width:auto; height:600px;">
      </div>

      <div class="item">
        <img src="KCF_img_6.jpeg" alt="Neequaye Slide" class="center" style=" width:auto; height:600px;">
      </div>
    
      <div class="item">
        <img src="KCF_img_7.jpg" alt="Cake Slide" class="center" style=" width:auto; height:600px;">
      </div>
    </div>
  ...
  <!-- messages section-->
       <section class="msg"><br><br>
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <tr>
                  <td> <i class='fa fa-guitar'>How we grow</i></td>
                  <td><button onclick="signedIn()" type="button" class="btn btn-success btn-lg">Get access</button></td>
                </tr>

                <tr>
                <td> <i class='fa fa-guitar'>Relationship Seminar</i></td>
                <td><button onclick="signedIn()" type="button" class="btn btn-success btn-lg">Get access</button></td>
                </tr>


                <tr>
                <td> <i class='fa fa-guitar'>Gifts of the Holy Spirit</i></td>
                <td><button onclick="signedIn()" type="button" class="btn btn-success btn-lg">Get access</button></td>
                </tr>
                ...
                <tr>
                <td><i class='fa fa-guitar'>Importance of fasting</i></td>
                <td> <button onclick="signedIn()" type="button" class="btn btn-success btn-lg">Get access</button></td>
                </tr>

                <tr>
                <td><i class='fa fa-guitar'>Technicalities of worship</i></td>
                <td><button onclick="signedIn()" type="button" class="btn btn-success btn-lg">Get access</button></td>
                </tr>
...
<!--section for meeting times-->
      <section class="meeting"><br><br>
        ...
        <section class="beths"><br><br>
             <center>
              <div class="d1">
              <i class='fa fa-user-friends' style='font-size:36px; background-color: gray; width:250px; border-radius: 10px;'>Kingdom Groups</i>
              </div>
            </center><br><br> >
      ...
      <tr>
        ...
        <th scope="col">Group Name</th>
            ...
            <tbody>
              ...
              <td>Kingdom Fellowship Choir</td>
            </tr>
            <tr>
              
              <th scope="row">Acting</th>
              <td>Kingdom Theatre Ministry</td>
            </tr>
            <tr>
              <th scope="row">Ushering</th>
              <td>Kingdom Ushers</td>
            </tr>
            <tr>
              <th scope="row">Praying, Fasting</th>
                <td>Prayer Warriors</td>
            </tr>
            <tr>
              <th scope="row">Fundrasing , Welfare</th>
                <td>Outreach & Welfare Committee</td>
            </tr>
          </tbody>
   </table>
   </section>
