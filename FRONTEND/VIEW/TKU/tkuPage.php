...
<head>
  ...
  <link rel="stylesheet" href="tkuCSS.css">
</head>
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <img src="tkulogo.jpg" alt="Logo" width="200px" height="210px" style="margin-top: -100px;">
      </a>
    </div>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="TKU_img_1.jpg" alt="First Slide" class="center" style=" width:auto; height:600px; " >
      </div>

      <div class="item">
        <img src="TKU_img_2.jpg" alt="Second Slide" class="center" style=" width:auto; height:600px;">
      </div>
    
      <div class="item">
        <img src="TKU_img_3.jpg" alt="Third Slide" class="center" style=" width:auto; height:600px;">
      </div>

      <div class="item">
        <img src="TKU_img_4.jpg" alt="Second Slide" class="center" style=" width:auto; height:600px;">
      </div>
    
      <div class="item">
        <img src="TKU_img_5.jpg" alt="Third Slide" class="center" style=" width:auto; height:600px;">
      </div>

      <div class="item">
        <img src="TKU_img_6.jpg" alt="Second Slide" class="center" style=" width:auto; height:600px;">
      </div>
    
      <div class="item">
        <img src="TKU_img_7.jpg" alt="Third Slide" class="center" style=" width:auto; height:600px;">
      </div>
    </div>
...
<!--award section of Page-->
  ...
  <!-- messages section-->
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <tr>
                  <td> <i class='fa fa-spotify'> What is Man?</i></td>
                  <td><button onclick="signedIn()" type="button" class="btn btn-success btn-lg">Get access</button></td>
                </tr>

                <tr>
                <td> <i class='fa fa-spotify'> Joy of the scriptures</i></td>
                <td><button onclick="signedIn()" type="button" class="btn btn-success btn-lg">Get access</button></td>
                </tr>


                <tr>
                <td> <i class='fa fa-spotify'>Living victoriously</i></td>
                <td><button onclick="signedIn()" type="button" class="btn btn-success btn-lg">Get access</button></td>
                </tr>
                ...
                <tr>
                <td> <i class='fa fa-spotify'>Challenged by the word</i></td>
                <td> <button onclick="signedIn()" type="button" class="btn btn-success btn-lg">Get access</button></td>
                </tr>

                <tr>
                <td><i class='fa fa-spotify'>Be responsible</i></td>
                <td><button onclick="signedIn()" type="button" class="btn btn-success btn-lg">Get access</button></td>
                </tr>
...
<!--section for meeting times-->
      <section class="meeting"><br><br>
        ...
        <section class="beths"><br><br>
             <center>
              <div class="d1">
              <i class='fa fa-user-friends' style='font-size:36px'>Beths</i>
              </div>
            </center><br><br> 
 ...
 <div class="container-fluid">                             
      ...
      <tr>
        ...
        <th scope="col">Beth Name</th>
            ...
            <tbody>
              ...
              <td>The Kings Choir</td>
            </tr>
            <tr>
              
              <th scope="row">Poetry,Storytelling,Acting</th>
              <td>Beth Arts</td>
            </tr>
            <tr>
              <th scope="row">Engineering, Software Development, Photography</th>
              <td>Smart Beth</td>
            </tr>
            <tr>
              <th scope="row">Planning, Event  Management</th>
                <td>Beth Management</td>
            </tr>
          </tbody>
   </table>
   </section>
  ...
  <ul class="pagination pagination-lg">
    ...
    <li><a class="pagination pagination-danger" href="../../HOME/index.php">Back to Home</a></li>
