...
<head>
    ...
    <title>FIRST LOVE MEMBERS BIRTHDAYS</title>
...
<div class="card w-75" style="margin-top: -720px; margin-left:270px">
  ...
  <span><i class="fa fa-birthday-cake"></i>Birthday Table</span>
  </div>
  <div class="card-body">
     
      <?php 
                            $query="SELECT fname, lname,dobmonth, dob FROM members WHERE fellowship_id=114";
  ...
  <div class="card-footer text-light bg-warning">
      <p>What better way to show love than on your birthday!</p>
  </div>
</div>
</body>
</html>