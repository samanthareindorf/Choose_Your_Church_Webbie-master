...
if(isset($_POST['submit']))
{
    ...
    if(!empty($_FILES["image"]["name"]))
    {
        ...
        {
            // array_push($erros, "File is too large. 5MB expected");
            // echo "File is too large. 5MB expected";
            $_SESSION['message2']="File is too large. 5MB expected";
        }
        ...
        elseif($image_file_type != "jpg" && $image_file_type != "png" && $image_file_type != "gif" && $image_file_type != "jpeg" && $image_file_type != "jfif")
        {
            ...
            // echo "<h3 style='color:red'>Sorry, only JPG, PNG & GIF files are allowed</h3>";
         ...
         else
         {
            ...
            {
               echo $_SESSION['message2']="Not Uploaded";
