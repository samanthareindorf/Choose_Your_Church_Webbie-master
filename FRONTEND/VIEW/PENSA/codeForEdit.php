...
{   $id=$_POST['edit_id'];
    ...
    $query="UPDATE pensa_user_testimony SET testimony_statement='$testimony', testimony_date='$testimonyDate' WHERE testimony_id='$id'" ;
    ...
    if($runQuery)
    {
        ...
        header("Location: PENSAindividual.php");
    }else
    {
