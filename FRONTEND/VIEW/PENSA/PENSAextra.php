...
<head>
    ...
    <title>Testimonies Page PENSA</title>
...
<div class="card w-75" style="margin-top: -600px; margin-left:270px">
  ...
  <div class="card-body">
      ...
      //to get extra currcula activities of just KCF--> 
                            ...
                            FROM  extra_curriculum INNER JOIN fellowship_curriculum on fellowship_curriculum.extra_id=extra_curriculum.extra_id WHERE fellowship_id=113";
