...
// testimony form controller--some changes need to be here. Should be member and not fellowship, 
            ...
            if(isset($_POST['postTestimony'])){
                ...
                $sqlQuery="INSERT INTO pensa_user_testimony (user_id,testimony_statement, testimony_date) VALUES ('$user_id','$testimony_statement','$testimony_date')";
...
<head>
    ...
    <title>PENSA Page Personal</title>
...
<form style="margin-left: 270px; margin-top: -779px; width:1100px" method="POST">
  ...
  <button type="submit" name="postTestimony" class="btn btn-primary">Submit</button>
</form><br>
  ...
  <div class="card-body">
      ...
      <?php 
                          ...
                          $user_id=$_SESSION['auth_user']['user_id'];
                            ...
                            $query="SELECT users.user_id, users.fname, users.lname, pensa_user_testimony.testimony_statement, pensa_user_testimony.testimony_id, pensa_user_testimony.testimony_date FROM users 
                            INNER JOIN pensa_user_testimony on pensa_user_testimony.user_id=$user_id WHERE fellowship_id=113 AND users.user_id=$user_id";
