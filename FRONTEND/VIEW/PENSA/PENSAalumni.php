...
<div class="card w-75" style="margin-top: -600px; margin-left:270px">
  ...
  <span><i class='fas fa-user-graduate'></i>PENSA Alumni Section</span>
  </div>
  <div class="card-body">
      ...
      //to get extra currcula activities of just KCF--> 
                            $query="SELECT work_section.company_name, work_section.work_position, members.fname, members.lname,members.phone_number FROM work_section INNER JOIN members ON work_section.member_id=members.member_id WHERE fellowship_id=113";
